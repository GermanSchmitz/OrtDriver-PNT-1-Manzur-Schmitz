...
namespace OrtDriver.Controllers
{
    public class ConductoresController : Controller
    {
        ...
        public ConductoresController(OrtDriverDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ConductorId,ConductorName,ConductorSurname,Dni,Email,FechaInscripto")] Conductor conductor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ConductorId,ConductorName,ConductorSurname,Dni,Email,FechaInscripto")] Conductor conductor)
        {
